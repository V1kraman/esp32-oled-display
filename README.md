...
No serial data during connection

Use BOOT during upload

OLED blank

Display communication uncertain

Run I²C scanner

Wrong controller assumption

SSD1306 path did not match hardware

Use SH1106 + Adafruit SH110X

Scrambled video

Bitmap data interpreted with wrong packing

Use Adafruit GFX drawBitmap()

Vertical video distortion

Source aspect ratio did not match 128×64

Crop useful content before resizing

Poor monochrome detail

Simple threshold lost shades

Use dithering

Large video files

Raw frames consume flash quickly

Explore binary filesystem storage
